...
{
    NSString *urlString = [[[NTESConfig sharedConfig] apiURL] stringByAppendingString:@"/chatroom/homeList"];
    ...
    [request addValue:[NTESConfig sharedConfig].appKey forHTTPHeaderField:@"appkey"];
