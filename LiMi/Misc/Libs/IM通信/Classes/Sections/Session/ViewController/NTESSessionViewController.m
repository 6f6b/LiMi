...
- (void)setUpNav{
    ...
    [infoBtn setImage:[UIImage imageNamed:@"im_icon_wd"] forState:UIControlStateNormal];
    [infoBtn setImage:[UIImage imageNamed:@"im_icon_wd"] forState:UIControlStateHighlighted];
