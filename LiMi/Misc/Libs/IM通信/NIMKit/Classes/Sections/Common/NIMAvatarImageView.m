...
- (void)setAvatarBySession:(NIMSession *)session
{
    ...
    NSString *avatarString = [info.avatarUrlString componentsSeparatedByString:@"?"][0];
    avatarString = [NSString stringWithFormat:@"http:%@",[[avatarString componentsSeparatedByString:@":"] lastObject]];
    NSURL *url = info.avatarUrlString ? [NSURL URLWithString:avatarString] : nil;
