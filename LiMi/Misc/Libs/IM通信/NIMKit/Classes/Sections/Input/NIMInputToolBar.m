...
//        [self setBackgroundColor:[UIColor whiteColor]];
        ...
        [_voiceButton setImage:[UIImage nim_imageInKit:@"im_icon_yy"] forState:UIControlStateHighlighted];
...
//        [_voiceButton setImage:[UIImage nim_imageInKit:@"icon_toolview_voice_pressed"] forState:UIControlStateHighlighted];
        ...
        [_emoticonBtn setImage:[UIImage nim_imageInKit:@"im_icon_bq"] forState:UIControlStateNormal];
        [_emoticonBtn setImage:[UIImage nim_imageInKit:@"im_icon_bq"] forState:UIControlStateHighlighted];
...
//        [_emoticonBtn setImage:[UIImage nim_imageInKit:@"icon_toolview_emotion_pressed"] forState:UIControlStateHighlighted];
        ...
        [_moreMediaBtn setImage:[UIImage nim_imageInKit:@"im_icon_jia"] forState:UIControlStateNormal];
        [_moreMediaBtn setImage:[UIImage nim_imageInKit:@"im_icon_jia"] forState:UIControlStateHighlighted];
...
{
    [self.voiceButton setImage:selected?[UIImage nim_imageInKit:@"im_icon_yy"]:[UIImage nim_imageInKit:@"icon_toolview_keyboard_normal"] forState:UIControlStateNormal];
    [self.voiceButton setImage:selected?[UIImage nim_imageInKit:@"im_icon_yy"]:[UIImage nim_imageInKit:@"icon_toolview_keyboard_pressed"] forState:UIControlStateHighlighted];
...
{
    [self.emoticonBtn setImage:selected?[UIImage nim_imageInKit:@"im_icon_bq"]:[UIImage nim_imageInKit:@"icon_toolview_keyboard_normal"] forState:UIControlStateNormal];
    [self.emoticonBtn setImage:selected?[UIImage nim_imageInKit:@"im_icon_bq"]:[UIImage nim_imageInKit:@"icon_toolview_keyboard_pressed"] forState:UIControlStateHighlighted];
