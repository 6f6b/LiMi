...
//Edit by LiuFeng   (NIM) 2018/2/10
- (NSArray *)defaultMediaItems
{
    return @[[NIMMediaItem item:@"onTapMediaItemPicture:"
                    normalImage:[UIImage nim_imageInKit:@"im_buttun_zp"]
                  selectedImage:[UIImage nim_imageInKit:@"im_buttun_zp"]
                          title:@"照片"],
             
             [NIMMediaItem item:@"onTapMediaItemShoot:"
                    normalImage:[UIImage nim_imageInKit:@"im_buttun_ps"]
                  selectedImage:[UIImage nim_imageInKit:@"im_buttun_ps"]
                          title:@"拍摄"],
             
             [NIMMediaItem item:@"onTapMediaItemLocation:"
                    normalImage:[UIImage nim_imageInKit:@"im_buttun_wz"]
                  selectedImage:[UIImage nim_imageInKit:@"im_buttun_wz"]
                          title:@"位置"],
             ];
//    return @[[NIMMediaItem item:@"onTapMediaItemPicture:"
