...
@interface AliyunPublishContentEditView ()<UITextViewDelegate>
...
//        self.backgroundColor = UIColor.greenColor;
        ...
        _textView = [[UITextView alloc] initWithFrame:CGRectMake(15, 10, frame.size.width-30, frame.size.height-20)];
