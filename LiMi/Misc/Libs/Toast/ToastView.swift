...
class ToastContentViewWithPictureAndText: ToastContentViewWithText {
    ...
    override init(frame: CGRect) {
        ...
        self.indicateImg.contentMode = .scaleAspectFill
        var animationImages = [UIImage]()
        for i in 0...118{
            //loading_56x56_00000
            let imageName = String.init(format: "loading_56x56_00%03d", i)
            animationImages.append(UIImage.init(named: imageName)!)
        }
