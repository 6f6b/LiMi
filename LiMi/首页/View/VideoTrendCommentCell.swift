...
class VideoTrendCommentCell: UITableViewCell {
    ///最底层容器
    var commentContainView:UIView!
    
    /******************顶部工具栏******************/
    var commentTopToolsContainView:VideoCommentTopToolsContainView!    //顶部工具栏容器
    ...
    override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
        ...
        self.commentTopToolsContainView = VideoCommentTopToolsContainView()
        ...
        self.comment.textColor = RGBA(r: 255, g: 255, b: 255, a: 1)
        ...
        separateLine.backgroundColor = RGBA(r: 30, g: 30, b: 30, a: 1)
        ...
        self.commentContainView.backgroundColor = RGBA(r: 30, g: 30, b: 30, a: 1)
//        ///最底层容器
//        var commentContainView:UIView!
//        
//        /******************顶部工具栏******************/
...
//        var blankView:UIView!
    ...
    func configWith(model:CommentModel?,isForSubComment:Bool = false){
        ...
        if let commentContent = model?.content{
            ...
            attCommentContent.yy_setTextHighlight(attCommentContentRange, color: RGBA(r: 255, g: 255, b: 255, a: 1), backgroundColor: nil, userInfo: nil, tapAction: { (view, nsAttStr, range, rect) in
                NotificationCenter.default.post(name: TAPED_COMMENT_NOTIFICATION, object: nil, userInfo: [COMMENT_MODEL_KEY:self.commentModel])
                print("短点击：\(nsAttStr)")
            }, longPressAction: { (view, nsAttStr, range, rect) in
                NotificationCenter.default.post(name: LONGPRESS_COMMENT_NOTIFICATION, object: nil, userInfo: [COMMENT_MODEL_KEY:self.commentModel])
