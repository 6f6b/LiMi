...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ORCycleLabel/ORCycleLabel.framework"
  ...
  install_framework "${PODS_ROOT}/QuCore-ThirdParty/frameworks/QuCore-ThirdParty.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/TextRotateView/TextRotateView.framework"
